...
const colleaguesData = {
    ...
    mayank: { 
        name: "Mayank Sinha",
        role: "The Automation Wizard",
        message: "Happy Birthday! Wishing you a bug-free day and a year full of smooth deployments and perfectly executed test scripts. Have a fantastic celebration!",
        lottieUrl: "https://lottie.host/bddc1470-3e4e-4ead-ba88-3e49065242a9/6mhc7b2MOH.lottie"
    },
    colleague4: { // Update this key to the person's first name
        name: "Enter Name Here",
        role: "Enter Role Here",
        message: "Type their special birthday message here!",
        // Your newly added 4th link
